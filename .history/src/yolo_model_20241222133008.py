...
class YOLOModel:
    def __init__(self, model_path):
        ...
        self.colors = [
    (102, 204, 0), (102, 204, 0), (102, 204, 0),  # Verde brillante (Biodegradable)
    (51, 102, 153), (51, 102, 153), (51, 102, 153),  # Marrón cálido (Cartón)
    (192, 192, 192), (192, 192, 192), (192, 192, 192), (192, 192, 192), (192, 192, 192),  # Gris metálico (Metal)
    (255, 128, 0), (255, 128, 0), (255, 128, 0), (255, 128, 0), (255, 128, 0), (255, 128, 0),  # Azul intenso (Vidrio)
    (51, 51, 255),  # Rojo vibrante (Nocivo)
    (102, 255, 255), (102, 255, 255), (102, 255, 255), (102, 255, 255), (102, 255, 255),  # Amarillo claro (Papel)
    ...
    def draw_boxes(self, image, results):
        ...
        for r in results:
            ...
            cv2.rectangle(image, (int(x1), int(y1)), (int(x2), int(y2)), self.colors[int(cls)], thickness)
